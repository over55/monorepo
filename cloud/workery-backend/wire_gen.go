...
func InitializeEvent() Application {
	...
	taskItemController := controller19.NewController(conf, slogLogger, provider, s3Storager, passwordProvider, kmutexProvider, templatedEmailer, client, commentStorer, howHearAboutUsItemStorer, tagStorer, userStorer, activitySheetStorer, customerStorer, taskItemStorer, associateStorer, associateAwayLogStorer, orderStorer, serviceFeeStorer)
	...
	taskqueueHandler := taskqueue2.NewHandler(slogLogger, tenantStorer, associateStorer, associateAwayLogStorer)
