...
type HowHearAboutUsItemStorer interface {
	...
	CountByFilter(ctx context.Context, f *HowHearAboutUsItemPaginationListFilter) (int64, error)
	ListAndCountByFilter(ctx context.Context, f *HowHearAboutUsItemPaginationListFilter) (*HowHearAboutUsItemPaginationListAndCountResult, error)
