...
func (c *SkillSetControllerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *skillset_s.SkillSetListFilter) ([]*skillset_s.SkillSetAsSelectOption, error) {
	...
	m, err := c.SkillSetStorer.ListAsSelectOptionByFilter(ctx, f)
	if err != nil {
