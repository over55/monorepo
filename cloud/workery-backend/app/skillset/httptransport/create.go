...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*skillset_c.SkillSetCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData skillset_c.SkillSetCreateRequestIDO
...
func MarshalCreateResponse(res *skillset_s.SkillSet, w http.ResponseWriter) {
