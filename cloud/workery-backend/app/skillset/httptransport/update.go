...
func UnmarshalUpdateRequest(ctx context.Context, r *http.Request) (*skillset_c.SkillSetUpdateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData skillset_c.SkillSetUpdateRequestIDO
...
func MarshalUpdateResponse(res *skillset_s.SkillSet, w http.ResponseWriter) {
