...
type SkillSetStorer interface {
	...
	CountByFilter(ctx context.Context, f *SkillSetPaginationListFilter) (int64, error)
	ListAndCountByFilter(ctx context.Context, f *SkillSetPaginationListFilter) (*SkillSetPaginationListAndCountResult, error)
