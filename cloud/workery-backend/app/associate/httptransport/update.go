...
func (h *Handler) unmarshalUpdateRequest(ctx context.Context, r *http.Request) (*c_c.AssociateUpdateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.AssociateUpdateRequestIDO
...
func (h *Handler) UpdateByID(w http.ResponseWriter, r *http.Request, id string) {
	...
	associate, err := h.Controller.UpdateByID(ctx, data)
	if err != nil {
		httperror.ResponseError(w, err)
		return
	}

	MarshalUpdateResponse(associate, w)
}
