...
func (impl *AssociateControllerImpl) validateOperationAvatarRequest(ctx context.Context, dirtyData *AssociateOperationAvatarRequest) error {
...
func (impl *AssociateControllerImpl) Avatar(ctx context.Context, req *AssociateOperationAvatarRequest) (*c_s.Associate, error) {
	...
	if req.File != nil {
		...
		objectKey := fmt.Sprintf("tenant/%v/private/uploads/associate/%v/avatar/%v", tid.Hex(), req.AssociateID.Hex(), req.FileName)
