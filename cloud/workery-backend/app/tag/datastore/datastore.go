...
type TagStorer interface {
	...
	CountByFilter(ctx context.Context, f *TagPaginationListFilter) (int64, error)
	ListAndCountByFilter(ctx context.Context, f *TagPaginationListFilter) (*TagPaginationListAndCountResult, error)
