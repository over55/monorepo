...
type InsuranceRequirementStorer interface {
	...
	CountByFilter(ctx context.Context, f *InsuranceRequirementPaginationListFilter) (int64, error)
	ListAndCountByFilter(ctx context.Context, f *InsuranceRequirementPaginationListFilter) (*InsuranceRequirementPaginationListAndCountResult, error)
