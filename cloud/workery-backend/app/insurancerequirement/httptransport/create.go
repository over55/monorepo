...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*insurancerequirement_c.InsuranceRequirementCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData insurancerequirement_c.InsuranceRequirementCreateRequestIDO
...
func MarshalCreateResponse(res *insurancerequirement_s.InsuranceRequirement, w http.ResponseWriter) {
