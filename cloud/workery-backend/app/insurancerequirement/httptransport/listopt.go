...
func (h *Handler) ListAsSelectOptions(w http.ResponseWriter, r *http.Request) {
	...
	f := &insurancerequirement_s.InsuranceRequirementPaginationListFilter{
		PageSize: 1_000_000,
		// LastID:    "",
		SortField: "text",
		SortOrder: 1, // 1=ascending | -1=descending
		Status:    insurancerequirement_s.StatusActive,
	}
...
func MarshalListAsSelectOptionResponse(res []*insurancerequirement_s.InsuranceRequirementAsSelectOption, w http.ResponseWriter) {
