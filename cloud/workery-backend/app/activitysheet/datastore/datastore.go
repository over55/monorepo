...
const (
	...
	HowWasJobAcceptedPhone                = 1
	HowWasJobAcceptedText                 = 2
	HowWasJobAcceptedEmail                = 3
	HowWasJobAcceptedInPersonConfirmation = 4

	WhyJobDeclinedBusy                        = 1
	WhyJobDeclinedNoSkill                     = 2
	WhyJobDeclinedTravelTooFar                = 3
	WhyJobDeclinedDoesNotWishToWorkWithClient = 4
)
