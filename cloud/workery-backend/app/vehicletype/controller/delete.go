...
func (impl *VehicleTypeControllerImpl) DeleteByID(ctx context.Context, id primitive.ObjectID) error {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		vehicletype, err := impl.GetByID(sessCtx, id)
		if err != nil {
		...
		if err := impl.VehicleTypeStorer.DeleteByID(sessCtx, id); err != nil {
