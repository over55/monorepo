...
func (impl *VehicleTypeControllerImpl) validateCreateRequest(ctx context.Context, dirtyData *VehicleTypeCreateRequestIDO) error {
...
func (impl *VehicleTypeControllerImpl) Create(ctx context.Context, requestData *VehicleTypeCreateRequestIDO) (*vehicletype_s.VehicleType, error) {
	...
	impl.Kmutex.Lockf("create-vehicle-type-by-tenant-%s", tid.Hex())
	defer impl.Kmutex.Unlockf("create-vehicle-type-by-tenant-%s", tid.Hex())
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		vt := &vehicletype_s.VehicleType{}

		// Add defaults.
		vt.TenantID = tid
		vt.ID = primitive.NewObjectID()
		vt.CreatedAt = time.Now()
		vt.CreatedByUserID = userID
		vt.CreatedByUserName = userName
		vt.CreatedFromIPAddress = ipAddress
		...
		if err := impl.VehicleTypeStorer.Create(ctx, vt); err != nil {
