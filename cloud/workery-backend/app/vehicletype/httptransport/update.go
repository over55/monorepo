...
func UnmarshalUpdateRequest(ctx context.Context, r *http.Request) (*vehicletype_c.VehicleTypeUpdateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData vehicletype_c.VehicleTypeUpdateRequestIDO
...
func MarshalUpdateResponse(res *vehicletype_s.VehicleType, w http.ResponseWriter) {
