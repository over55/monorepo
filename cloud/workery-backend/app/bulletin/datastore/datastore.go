...
type BulletinStorer interface {
	...
	CountByFilter(ctx context.Context, f *BulletinPaginationListFilter) (int64, error)
	ListAndCountByFilter(ctx context.Context, f *BulletinPaginationListFilter) (*BulletinPaginationListAndCountResult, error)
