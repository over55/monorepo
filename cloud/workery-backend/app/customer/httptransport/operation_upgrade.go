...
func UnmarshalOperationUpgradeRequest(ctx context.Context, r *http.Request) (*c_c.CustomerOperationUpgradeRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.CustomerOperationUpgradeRequest
...
func MarshalOperationUpgradeResponse(res *c_s.Customer, w http.ResponseWriter) {
