...
func UnmarshalOperationChangePasswordRequest(ctx context.Context, r *http.Request) (*c_c.CustomerOperationChangePasswordRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.CustomerOperationChangePasswordRequest
