...
func UnmarshalOperationDowngradeRequest(ctx context.Context, r *http.Request) (*c_c.CustomerOperationDowngradeRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.CustomerOperationDowngradeRequest
...
func MarshalOperationDowngradeResponse(res *c_s.Customer, w http.ResponseWriter) {
