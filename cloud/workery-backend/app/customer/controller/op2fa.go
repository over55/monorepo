...
func (impl *CustomerControllerImpl) validateOperationChangeTwoFactorAuthenticationRequest(ctx context.Context, dirtyData *CustomerOperationChangeTwoFactorAuthenticationRequest) error {
...
func (impl *CustomerControllerImpl) ChangeTwoFactorAuthentication(ctx context.Context, req *CustomerOperationChangeTwoFactorAuthenticationRequest) error {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		s, err := impl.CustomerStorer.GetByID(sessCtx, req.CustomerID)
		if err != nil {
		...
		if err := impl.CustomerStorer.UpdateByID(sessCtx, s); err != nil {
			impl.Logger.Error("update customer error", slog.Any("err", err))
			return nil, err
		}
