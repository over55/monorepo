...
func (impl *CustomerControllerImpl) validateOperationAvatarRequest(ctx context.Context, dirtyData *CustomerOperationAvatarRequest) error {
...
func (impl *CustomerControllerImpl) Avatar(ctx context.Context, req *CustomerOperationAvatarRequest) (*c_s.Customer, error) {
	...
	if req.File != nil {
		...
		objectKey := fmt.Sprintf("tenant/%v/private/uploads/client/%v/avatar/%v", tid.Hex(), req.CustomerID.Hex(), req.FileName)
