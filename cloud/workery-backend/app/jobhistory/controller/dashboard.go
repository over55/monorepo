...
func (impl *JobHistoryControllerImpl) getActiveClientsCount(ctx context.Context, tenantID primitive.ObjectID) (int64, error) {
...
func (impl *JobHistoryControllerImpl) getActiveAssociatesCount(ctx context.Context, tenantID primitive.ObjectID) (int64, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) getActiveJobsCount(ctx context.Context, tenantID primitive.ObjectID) (int64, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) getActiveTasksCount(ctx context.Context, tenantID primitive.ObjectID) (int64, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) getAwayLogs(ctx context.Context, tenantID primitive.ObjectID) ([]*away_s.AssociateAwayLog, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) getBulletins(ctx context.Context, tenantID primitive.ObjectID) ([]*b_s.Bulletin, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) getOrderComments(ctx context.Context, tenantID primitive.ObjectID) ([]*com_s.Comment, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
...
func (impl *JobHistoryControllerImpl) JobHistory(ctx context.Context) (*JobHistoryResponseIDO, error) {
	startTime := time.Now() // Capture the start time
	defer func() {
		duration := time.Since(startTime).Seconds() // Calculate the duration in seconds
		impl.Logger.Debug("executed",
