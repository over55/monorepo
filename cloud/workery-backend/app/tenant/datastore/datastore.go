...
type Tenant struct {
	...
	LatestCustomerID        primitive.ObjectID `bson:"latest_customer_id" json:"latest_customer_id,omitempty"`
	LatestCustomerPublicID  uint64             `bson:"latest_customer_public_id" json:"latest_customer_public_id,omitempty"`
	LatestAssociateID       primitive.ObjectID `bson:"latest_associate_id" json:"latest_associate_id,omitempty"`
	LatestAssociatePublicID uint64             `bson:"latest_associate_public_id" json:"latest_associate_public_id,omitempty"`
	LatestOrderID           primitive.ObjectID `bson:"latest_order_id" json:"latest_order_id,omitempty"`
