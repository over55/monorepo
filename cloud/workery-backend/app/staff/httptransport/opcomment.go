...
func UnmarshalOperationCreateCommentRequest(ctx context.Context, r *http.Request) (*c_c.StaffOperationCreateCommentRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.StaffOperationCreateCommentRequest
...
func MarshalOperationCreateCommentResponse(res *c_s.Staff, w http.ResponseWriter) {
