...
func UnmarshalOperationChangeTwoFactorAuthenticationRequest(ctx context.Context, r *http.Request) (*c_c.StaffOperationChangeTwoFactorAuthenticationRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.StaffOperationChangeTwoFactorAuthenticationRequest
