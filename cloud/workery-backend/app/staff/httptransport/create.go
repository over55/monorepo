...
func (h *Handler) unmarshalCreateRequest(ctx context.Context, r *http.Request) (*usr_c.StaffCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData *usr_c.StaffCreateRequestIDO
...
func MarshalCreateResponse(res *usr_s.Staff, w http.ResponseWriter) {
