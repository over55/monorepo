...
func UnmarshalOperationDowngradeRequest(ctx context.Context, r *http.Request) (*c_c.StaffOperationDowngradeRequest, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.StaffOperationDowngradeRequest
...
func MarshalOperationDowngradeResponse(res *c_s.Staff, w http.ResponseWriter) {
