...
func (h *Handler) unmarshalUpdateRequest(ctx context.Context, r *http.Request) (*c_c.StaffUpdateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData c_c.StaffUpdateRequestIDO
...
func (h *Handler) UpdateByID(w http.ResponseWriter, r *http.Request, id string) {
	...
	staff, err := h.Controller.UpdateByID(ctx, data)
	if err != nil {
		httperror.ResponseError(w, err)
		return
	}

	MarshalUpdateResponse(staff, w)
}

func MarshalUpdateResponse(res *c_s.Staff, w http.ResponseWriter) {
