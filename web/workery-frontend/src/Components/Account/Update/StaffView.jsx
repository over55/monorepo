...
function AccountStaffUpdate({ currentUser, setCurrentUser }) {
  ////
  //// Global state.
  ////
  ...
  function onAccountDetailSuccess(response) {
    ...
    // // Step 3
    // setCurrentUserType(response.type);
  ...
  function onSuccess(response) {
    ...
    setForceURL("/admin/currentUser/" + response.id);
  }
                ...
                {currentUser && (
                  <div className="container">
                    ...
                    <FormRadioField
                      ...
                      helpText=""
                      onChange={(e) =>
                        setCurrentUserType(parseInt(e.target.value))
                      }
                    />
                    ...
                    {currentUserType === COMMERCIAL_ASSOCIATE_TYPE_OF_ID && (
                      <>{/* Do nothing */}</>
                    )}
                    ...
                    <FormMultiSelectFieldForVehicleType
                      ...
                      helpText="Pick the vehicle types you would like to currentUser with this cliient."
                      isRequired={true}
                    />
                    ...
                    <FormMultiSelectFieldForTags
                      ...
                      helpText="Pick the tags you would like to currentUser with this cliient."
                      isRequired={true}
                      maxWidth="320px"
                    />
...
export default AccountStaffUpdate;
