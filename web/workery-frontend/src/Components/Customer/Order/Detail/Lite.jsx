...
function CustomerOrderDetailLite() {
  ////
  //// URL Parameters.
  ////
        ...
        <section className="section">
          ...
          >
            <ul>
              ...
              <li className="">
                <Link to="/c/orders" aria-current="page">
                  ...
                  <div className="container">
                    ...
                    <div className="tabs is-medium is-size-6-tablet is-size-7-mobile">
                      <ul>
                        ...
                        <li>
                          <Link to={`/c/order/${oid}/full`}>Detail</Link>
                        </li>
                        {/*
                        <li>
                          <Link to={`/c/order/${oid}/activity-sheets`}>
                            Activity Sheets
                          </Link>
                        </li>
                        <li>
                          <Link to={`/c/order/${oid}/tasks`}>Tasks</Link>
                        </li>
                        <li>
                          <Link to={`/c/order/${oid}/comments`}>
                            Comments
                          </Link>
                        </li>
                        <li>
                          <Link to={`/c/order/${oid}/attachments`}>
                            Attachments
                          </Link>
                        </li>
                        <li>
                          <Link to={`/c/order/${oid}/more`}>
                            More&nbsp;&nbsp;
                            <FontAwesomeIcon
                              className="mdi"
                              icon={faEllipsis}
...
export default CustomerOrderDetailLite;
