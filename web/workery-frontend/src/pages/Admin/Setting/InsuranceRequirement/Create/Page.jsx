...
function SettingInsuranceRequirementCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccessMessage("Insurance requirement created successfully!");
              ...
              <div className="p-6">
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex items-start">
                    <BuildingOfficeIcon className="w-4 h-4 mr-2 text-blue-500 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <ShieldCheckIcon className="w-4 h-4 mr-2 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>Professional Liability</span>
                  </li>
                  <li className="flex items-start">
                    <DocumentTextIcon className="w-4 h-4 mr-2 text-orange-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-white shadow-sm rounded-lg">
              ...
              <div className="p-6">
                <div className="space-y-3 text-sm text-gray-600">
                  <p>
                    Create clear, specific insurance requirements that can be
                    easily understood by associates and clients.
                  </p>
                  <p>
                    Use standard industry terminology when possible to avoid
                    confusion.
                  </p>
                  <p>
                    Consider including coverage limits or specific requirements
