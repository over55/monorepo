    ...
    <div style={{ padding: "20px" }}>
      ...
      {showSuccessMessage && (
        <Alert type="success" onClose={() => setShowSuccessMessage(false)}>
          Staff downgraded successfully! Redirecting...
        </Alert>
      )}
          ...
          <div>
            ...
            >
              ...
              <p style={{ margin: 0, color: "#856404", lineHeight: "1.6" }}>
                You are about to <strong>downgrade</strong> this staff member
                from <em>Management</em> type to <em>Frontline Staff</em>. This
                will affect the permission system. Are you sure you want to
                continue?
              </p>
            </div>
