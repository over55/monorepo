...
function AdminOrderDetailAttachmentDeletePage() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (
        attachmentData.orderId !== oid &&
        attachmentData.ownershipId !== oid
      ) {
        setErrors({
          general: "This attachment does not belong to the selected order",
        });
      }
    } catch (error) {
  ...
  const handleCancel = () => {
    navigate(`/admin/order/${oid}/attachment/${aid}`);
  };
