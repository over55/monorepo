...
function AdminCustomerDetailOrderListPage() {
  ...
  const fetchOrderList = useCallback(
    async (cursor = "", isNavigatingBack = false) => {
      ...
      try {
        ...
        // IMPORTANT: Always include customer_id filter
        ...
        if (
          currentFilters.createdAtGTE !== undefined &&
          currentFilters.createdAtGTE !== null &&
          currentFilters.createdAtGTE !== ""
        ) {
          const dateStr = currentFilters.createdAtGTE.getTime();
  ...
  // Initial load - fetch customer detail
  useEffect(() => {
    window.scrollTo(0, 0);
    fetchCustomerDetail();
  ...
  }, [cid]); // Only depend on cid, not fetchOrderList
                  ...
                  <div className="md:hidden space-y-4">
                    {orderList.results.map((order, index) => (
                      ...
                      >
                        ...
                        <div className="mb-3">
                          <strong className="text-gray-700">Associate:</strong>{" "}
                          {order.associateId &&
                          order.associateId !== "" &&
                          order.associateId !== "000000000000000000000000" ? (
                            <Link
