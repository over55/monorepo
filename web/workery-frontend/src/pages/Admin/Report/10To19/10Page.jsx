// File Path: monorepo/web/workery-frontend/src/pages/Admin/Report/10To19/10Page.jsx
...
function AdminReport10Page() {
  ...
  useEffect(() => {
    ...
    if (preferences?.report10) {
      setJobStatus(preferences.report10.jobStatus || 0);
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log("AdminReport10Page: Submitting report", {
      fromDate,
      toDate,
      jobStatus,
    });
    ...
    try {
      ...
      const filename = `residential_jobs_report_${timestamp}.csv`;

      await reportManager.downloadReport(
        10, // Report ID for Residential Jobs Report
        params,
        filename,
        onUnauthorized,
      );
      ...
      console.log("AdminReport10Page: Report downloaded successfully");
    } catch (error) {
      console.error("AdminReport10Page: Error downloading report", error);
  ...
  const recentDownloads = reportManager
    .getReportHistory()
    .filter(
      (item) => item.reportId === 10 || item.reportType === "Residential Jobs",
    )
    .slice(0, 5);
        ...
        <div className="lg:col-span-2">
          <Card className="h-full">
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center">
                <HomeModernIcon className="w-6 h-6 text-green-600 mr-3" />
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Residential Jobs Report
                  </h1>
                  <p className="text-sm text-gray-600 mt-1">
                    Generate a detailed report of residential work orders within
                    a date range
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm">
                      ...
                      residential jobs within the specified date range. The
                      dates refer to the assignment date of the work orders. The
                      report includes customer details, job descriptions,
                      assigned associates, and completion status.
                    </p>
                  </div>
                </div>
              </Alert>
        ...
        <div className="lg:col-span-1">
          ...
          <Card className="mt-6">
            ...
            <div className="p-6">
              <div className="space-y-3">
                <div className="flex items-start">
                  <HomeModernIcon className="w-5 h-5 text-green-500 mr-3 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      Residential Jobs
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      All residential work orders in date range
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  <ClipboardDocumentCheckIcon className="w-5 h-5 text-blue-500 mr-3 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      Job Details
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      Description, status, and completion dates
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Assigned technicians and work hours
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  <BuildingOfficeIcon className="w-5 h-5 text-amber-500 mr-3 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      Customer Information
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      Client details and service addresses
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6">
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>
                    Use this report to analyze residential job patterns
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
                  <span>
                    Filter by status to focus on pending or completed jobs
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
                  <span>
                    Export to track associate productivity and performance
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
                  <span>
                    Compare with commercial jobs for business insights
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
                  <span>Use date ranges to identify seasonal trends</span>
                </li>
              </ul>
            </div>
          </Card>
...
export default AdminReport10Page;
