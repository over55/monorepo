// File Path: monorepo/web/workery-frontend/src/pages/Admin/Report/00To09/05Page.jsx
...
function AdminReport05Page() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("AdminReport05Page: Submitting report");
    ...
    try {
      ...
      const filename = `associate_insurance_report_${timestamp}.csv`;

      await reportManager.downloadReport(
        5, // Report ID for Associate Insurance Report
        params,
        filename,
        onUnauthorized,
      );
      ...
      reportManager.saveReportPreferences({
        lastAssociateInsuranceReport: {
          lastDownloaded: new Date().toISOString(),
        },
      });

      console.log("AdminReport05Page: Report downloaded successfully");
    } catch (error) {
      console.error("AdminReport05Page: Error downloading report", error);
  ...
  const recentDownloads = reportManager
    ...
    .filter(
      (item) =>
        item.reportId === 5 || item.reportType === "Associate Insurance",
    )
    .slice(0, 5);
            ...
            <div className="p-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm">
                      This report will generate a CSV file containing current
                      insurance information for all active associates. The
                      report includes insurance policy details, expiration
                      dates, and coverage types.
                    </p>
                  </div>
                </div>
              </Alert>
              ...
              <div className="bg-gray-50 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  ...
                  below to generate and download the current associate insurance
                  report.
                </p>
                ...
                <div className="flex">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p>
                      ...
                      insurance status as of today's date.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="lg:col-span-1">
          ...
          <Card className="mt-6">
            ...
            <div className="p-6">
              <div className="space-y-3">
                <div className="flex items-start">
                  <UserGroupIcon className="w-5 h-5 text-indigo-500 mr-3 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start">
                  <ShieldCheckIcon className="w-5 h-5 text-indigo-500 mr-3 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      Insurance Details
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      Policy numbers, providers, and coverage types
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Policy expiration dates and renewal status
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  <DocumentTextIcon className="w-5 h-5 text-green-500 mr-3 mt-0.5" />
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      Compliance Status
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      Insurance requirement compliance indicators
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6">
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>
                    Review expiring policies to ensure continuous coverage
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>
                  <span>
                    Use this report for compliance audits and verification
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>
                  <span>
                    Export to Excel for sorting and filtering capabilities
                  </span>
                </li>
              </ul>
            </div>
...
export default AdminReport05Page;
