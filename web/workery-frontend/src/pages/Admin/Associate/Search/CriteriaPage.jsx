...
function AdminAssociateSearchCriteriaPage() {
  ...
  return (
    <div style={globalStyles.container}>
      ...
      {/* Search Form Card */}
      <Card title="🔍 Search for existing associate">
        ...
        <form onSubmit={onSubmitClick}>
          ...
          <FormGroup>
            ...
            <p style={{ fontSize: "12px", color: "#666", marginTop: "5px" }}>
              By selecting this checkbox, you will be shown only associates
              which are active, else unselecting checkbox will search all
              associates.
            </p>
          </FormGroup>
