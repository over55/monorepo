          ...
          <div className="flex justify-between items-center">
            ...
            {attachment && (
              <div className="flex gap-2">
                ...
                <Link to={`/admin/associate/${aid}/attachment/${atid}/delete`}>
                  <button className="inline-flex items-center px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-red-600 hover:bg-red-700 transition-colors">
