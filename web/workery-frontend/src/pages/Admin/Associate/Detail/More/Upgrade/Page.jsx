              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-amber-700">
                    <p>
                      You are about to <strong>upgrade</strong> this associate
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    This associate is already a Business type account. No
                    upgrade is needed.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <dl className="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="text-sm text-gray-900">{associate?.email}</dd>
              </div>
              <div>
            ...
            <>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    {ASSOCIATE_ORGANIZATION_TYPE_OPTIONS.map((option) => (
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        You are about to upgrade the following associate to
                        Business type:
                      </p>
