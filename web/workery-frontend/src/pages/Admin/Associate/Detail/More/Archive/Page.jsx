            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-amber-900 mb-2">
                  Archive Associate - Are you sure?
                </h3>
                ...
                <ul className="space-y-2 text-amber-700 ml-4">
                  <li className="flex items-start">
                    ...
                    The associate will no longer appear in the active associates
                    list
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-amber-600 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-amber-600 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                    All current assignments and tasks will remain but the
                    associate cannot receive new ones
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-amber-600 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {associate.typeOf && (
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900">
                      {getTypeDisplay(associate.typeOf)}
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        This action will remove the associate from all active
