// File Path: monorepo/web/workery-frontend-deprecated/src/API/HowHearAboutUsItem.js
...
export function getHowHearAboutUsItemSelectOptionListAPI(
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function getHowHearAboutUsItemListAPI(
  filtersMap = new Map(),
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
// export function getHowHearAboutUsItemSelectOptionListAPI(filtersMap=new Map(), onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
//     const axios = getCustomAxios(onUnauthorizedCallback);
//
//     // The following code will generate the query parameters for the url based on the map.
...
// }
//
export function postHowHearAboutUsItemCreateAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
  ...
  axios
    .post(WORKERY_HOW_HEAR_ABOUT_US_ITEMS_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function getHowHearAboutUsItemDetailAPI(
  organizationID,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
  ...
  axios
    .get(
      WORKERY_HOW_HEAR_ABOUT_US_ITEM_API_ENDPOINT.replace(
        "{id}",
        organizationID,
      ),
    )
...
export function putHowHearAboutUsItemUpdateAPI(
  decamelizedData,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function deleteHowHearAboutUsItemAPI(
  id,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .delete(WORKERY_HOW_HEAR_ABOUT_US_ITEM_API_ENDPOINT.replace("{id}", id))
    .then((successResponse) => {
      const responseData = successResponse.data;
...
// export function postHowHearAboutUsItemCreateCommentOperationAPI(organizationID, content, onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
//     const axios = getCustomAxios(onUnauthorizedCallback);
//     const data = {
