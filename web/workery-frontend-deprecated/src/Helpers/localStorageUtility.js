...
export function localStorageGetObjectItem(key) {
  ...
  if (stringifiedObject === "undefined") {
    // Defensive Code: Error.
    console.error(
      "localStorageGetObjectItem: Detected `undefined` string, could be potential error.",
    );
    return null;
  }
...
export function localStorageGetArrayItem(key) {
  ...
  if (stringifiedObject === "undefined") {
    // Defensive Code: Error.
    console.error(
      "localStorageGetArrayItem: Detected `undefined` string, could be potential error.",
    );
    return null;
  }
...
export function localStorageGetBooleanOrNullItem(key) {
  ...
  if (str === "undefined" || str === "null") {
    // Defensive Code: Error.
    console.error(
      "localStorageGetBooleanOrNullItem: Detected `undefined` string, could be potential error.",
    );
    return null;
  }
  if (
...
export function localStorageGetIntegerItem(key) {
  ...
  if (str === "undefined" || str === "null") {
    // Defensive Code: Error.
    console.error(
      "localStorageGetIntegerItem: Detected `undefined` string, could be potential error.",
    );
    return null;
  }
  return parseInt(str);
...
export function localStorageGetFloatItem(key) {
  ...
  if (str === "undefined" || str === "null") {
    // Defensive Code: Error.
    console.error(
      "localStorageGetFloatItem: Detected `undefined` string, could be potential error.",
    );
    return null;
  }
