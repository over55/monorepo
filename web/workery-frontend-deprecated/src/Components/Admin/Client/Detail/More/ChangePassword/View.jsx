// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Client/Detail/More/ChangePassword/View.jsx
...
import { postClientChangePasswordAPI } from "../../../../../../API/Client";
                    ...
                    <article className="message is-warning">
                      <div className="message-body">
                        ...
                        <p>
                          ...
                          client. Please make sure you enter it correctly or
                          else client will be locked out of the account and
