// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Client/Detail/More/2FA/ToggleView.jsx
...
import { postClientChangeTwoFactorAuthenticationAPI } from "../../../../../../API/Client";
import { getClientDetailAPI } from "../../../../../../API/Client";

function AdminClientMoreOperation2FAToggle() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = () => {
    setErrors({});
    setFetching(true);
    postClientChangeTwoFactorAuthenticationAPI(
      {
        customer_id: cid,
        otp_enabled: !Client.otpEnabled,
      },
  ...
  useEffect(() => {
    ...
    if (mounted) {
      ...
      setFetching(true);
      getClientDetailAPI(cid, onSuccess, onError, onDone);
    }
  ...
  console.log("Client.otpEnabled --->", Client.otpEnabled);
        ...
        <section className="section">
          ...
          >
            <ul>
              ...
              <li className="">
                <Link to="/admin/Client" aria-current="page">
                  ...
                  <div className="container">
                    {!Client.otpEnabled ? (
                      <article className="message is-success">
                        <div className="message-body">
                          ...
                          <p>
                            You are about to <b>enable 2FA</b> for this Client
                            member. This operation will force Client member on
                            next successfull login to be taken through a{" "}
                            <b>3-step wizard</b> to setup 2FA. Afterwords every
                            time the Client member logs in, they will be asked
                      ...
                      <article className="message is-warning">
                        <div className="message-body">
                          ...
                          <p>
                            You are about to <b>remove 2FA</b> for this Client
                            member. This operation will remove previous 2FA
                            settup codes and disable 2FA on login for this
                            Client. This is recommended if the user lost their
                    ...
                    <div className="columns pt-5">
                      ...
                      <div className="column is-half has-text-right">
                        <button
                          className={`button ${!Client.otpEnabled ? "is-success" : "is-warning"} is-fullwidth-mobile`}
...
export default AdminClientMoreOperation2FAToggle;
