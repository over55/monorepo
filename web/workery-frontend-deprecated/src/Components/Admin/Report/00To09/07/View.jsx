// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/07/View.jsx
...
import { ASSOCIATE_STATUS_FILTER_OPTIONS } from "../../../../../Constants/FieldOptions";
...
function AdminReport07() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 7) +
      "?state=" +
      associateStatus;
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_07.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faBirthdayCake} />
                  &nbsp;Associate Birthdays
                </Link>
              </li>
            </ul>
              ...
              <>
                ...
                <div className="container">
                  <FormSelectField
                    ...
                    placeholder="Pick"
                    selectedValue={associateStatus}
                    errorText={errors && errors.associateStatus}
                    helpText=""
                    onChange={(e) =>
