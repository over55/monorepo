// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/06/View.jsx
...
function AdminReport06() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL = WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 6);
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_06.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faShieldAlt} />
