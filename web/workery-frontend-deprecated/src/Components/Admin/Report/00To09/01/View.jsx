// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/01/View.jsx
...
function AdminReport01() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 1) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString +
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_01.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faCashRegister} />
