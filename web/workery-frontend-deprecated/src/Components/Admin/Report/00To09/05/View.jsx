// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/05/View.jsx
...
function AdminReport05() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL = WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 5);
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_05.csv");
