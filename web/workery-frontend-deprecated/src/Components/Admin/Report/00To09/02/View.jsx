// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/02/View.jsx
...
function AdminReport02() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 2) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString +
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_02.csv");
