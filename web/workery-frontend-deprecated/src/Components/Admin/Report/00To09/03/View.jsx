// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/00To09/03/View.jsx
...
function AdminReport03() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 3) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString;
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_03.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faHandHoldingUsd} />
              ...
              <>
                ...
                <div className="container">
                  <FormAlternateDateField
                    ...
                    value={fromDate}
                    helpText="Refers to invoice service fee payment date"
