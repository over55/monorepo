// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/10To19/16/View.jsx
...
function AdminReport16() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 16) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString +
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_16.csv");
