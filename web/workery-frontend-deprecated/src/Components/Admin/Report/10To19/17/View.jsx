// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/10To19/17/View.jsx
...
function AdminReport17() {
  ...
  const onSubmitClick = (e) => {
    ...
    if (userType === undefined || userType === null || userType === "") {
      newErrors["userType"] = "missing value";
      hasErrors = true;
    }
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 17) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString +
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_17.csv");
              ...
              <>
                ...
                <div className="container">
                  ...
                  <FormSelectField
                    ...
                    errorText={errors && errors.userType}
                    helpText=""
