// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/10To19/12/View.jsx
...
function AdminReport12() {
  ...
  const onSubmitClick = (e) => {
    ...
    // https://gist.github.com/javilobo8/127c30a233786be52070986d8cdb1743
    ...
    const aURL = WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 12);
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_12.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faToolbox} />
                  &nbsp;Skill Sets Report
                </Link>
              </li>
            </ul>
