// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/20To29/21/View.jsx
...
function AdminReport21() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL = WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 21);
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_21.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faMailBulk} />
