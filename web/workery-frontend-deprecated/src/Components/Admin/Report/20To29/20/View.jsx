// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/20To29/20/View.jsx
...
function AdminReport20() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 20) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString;
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_20.csv");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faSearchDollar} />
                  &nbsp;Payments Report
                </Link>
              </li>
            </ul>
              ...
              <>
                ...
                <div className="container">
                  <FormAlternateDateField
                    ...
                    value={fromDate}
                    helpText="Refers to the invoice service fee payment date"
