// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Report/20To29/22/View.jsx
...
function AdminReport22() {
  ...
  const onSubmitClick = (e) => {
    ...
    const aURL =
      WORKERY_REPORT_API_ENDPOINT.replace("{reportID}", 22) +
      "?from_dt=" +
      fromDateString +
      "&to_dt=" +
      toDateString +
  ...
  const onSuccessPDFDownloadCallback = (successResponse) => {
    ...
    link.href = url;
    link.setAttribute("download", "report_22.csv");
              ...
              <>
                ...
                <div className="container">
                  ...
                  <FormAlternateDateField
                    ...
                    value={fromDate}
                    helpText="Refers to completion date"
