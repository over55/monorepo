// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Associate/Detail/ChangePassword/View.jsx
...
import { postAssociateChangePasswordAPI } from "../../../../../../API/Associate";

function AdminAssociateMoreOperationChangePassword() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = () => {
    setErrors({});
    setFetching(true);
    postAssociateChangePasswordAPI(
      {
        associate_id: aid,
        password: password,
                    ...
                    <article className="message is-warning">
                      <div className="message-body">
                        ...
                        <p>
                          ...
                          associate. Please make sure you enter it correctly or
                          else associate will be locked out of the account and
...
export default AdminAssociateMoreOperationChangePassword;
