// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Associate/Search/Search.jsx
...
function AdminAssociateSearch() {
  ...
  const onSubmitClick = (e) => {
    ...
    let aURL =
      "/admin/associates/search-result?fn=" +
      firstName +
      "&ln=" +
      lastName +
      "&e=" +
              ...
              <>
                ...
                <div className="container">
                  ...
                  <FormCheckboxField
                    ...
                    helpText="By selecting this checkbox, you will be shown only associates which are active, else unselecting checkbox will search all associates."
                    onChange={(e) => {
...
export default AdminAssociateSearch;
