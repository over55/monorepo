// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Associate/Add/Step1PartB.jsx
...
function AdminAssociateAddStep1PartB() {
  ////
  //// URL Parameters.
  ////
...
export default AdminAssociateAddStep1PartB;
