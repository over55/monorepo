// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Financial/Detail/More/More.jsx
                  ...
                  <div className="container">
                    ...
                    <div className="tabs is-medium is-size-6-tablet is-size-7-mobile">
                      <ul>
                        ...
                        <li>
                          <Link to={`/admin/financial/${oid}/invoice`}>
                            Invoice
                          </Link>
                        </li>
                        <li className="is-active">
                    ...
                    <div className="columns is-vcentered is-multiline">
                      <div className="column">
                        <DashboardBubbleLink
                          ...
                          faIcon={faCodeBranch}
                          url={`/admin/financial/${oid}/more/clone`}
...
export default AdminFinancialMore;
