// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Financial/List/List.jsx
...
import AdminFinancialListDesktop from "./ListDesktop";
import AdminFinancialListMobile from "./ListMobile";

function AdminFinancialList() {
  ////
  //// Global state.
  ////
                ...
                <div className="columns is-vcentered">
                  <div className="column">
                    <BubbleLink
                      ...
                      subtitle={`Add orders`}
                      faIcon={faPlus}
                      url={`/admin/orders/add/step-1-search`}
                  ...
                  <section className="hero is-medium has-background-white-ter">
                    <div className="hero-body">
                      ...
                      <p className="subtitle">
                        No orders.{" "}
                        <b>
                          <Link to="/admin/orders/add/step-1">
                            Click here&nbsp;
                            <FontAwesomeIcon
                              className="mdi"
                              icon={faArrowRight}
...
export default AdminFinancialList;
