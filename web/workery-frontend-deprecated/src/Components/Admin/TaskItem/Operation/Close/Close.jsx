// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/TaskItem/Operation/Close/Close.jsx
...
import { postTaskCloseOperationAPI } from "../../../../../API/TaskItem";

function AdminTaskItemCloseOperation() {
  ////
  //// URL Parameters.
  ////
  ...
  function onOperationSuccess(response) {
    ...
    setTopAlertMessage("Task closed");
            ...
            <ul>
              ...
              <li className="is-active">
                <Link aria-current="page">
                  <FontAwesomeIcon className="fas" icon={faTimesSquare} />
                  &nbsp;Close Operation
                </Link>
              </li>
            </ul>
                        ...
                        {wasCompleted === 2 && (
                          <>
                            <FormSelectField
                              ...
                              options={
                                TASK_ITEM_CLOSE_REASON_OPTIONS_WITH_EMPTY_OPTION
                              }
                            />
...
export default AdminTaskItemCloseOperation;
