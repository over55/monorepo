// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/TaskItem/Update/AssignAssociate/Step1.jsx
...
function AdminTaskItemAssignAssociateStep1() {
  ////
  //// URL Parameters.
  ////
            ...
            {task && (
              <div className="columns">
                ...
                <div className="column has-text-right">
                  {/*
                                <Link to={`/admin/task/${tid}/assign-associate/step-2`} className="button is-small is-primary is-fullwidth-mobile" type="button" disabled={task.status === 2}>
...
export default AdminTaskItemAssignAssociateStep1;
