// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Order/Add/Step1PartA.jsx
...
function AdminOrderAddStep1PartA() {
  ////
  //// Global state.
  ////
  ...
  const onAddOrderClick = (e) => {
    ...
    setAddCustomer(ADD_ORDER_STATE_DEFAULT);
  ...
  const onSubmitClick = (e) => {
    ...
    setForceURL(
      "/admin/orders/add/step-1-results?fn=" +
        firstName +
        "&ln=" +
        lastName +
        "&e=" +
...
export default AdminOrderAddStep1PartA;
