// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Order/List/View.jsx
...
import AdminOrderListDesktop from "./TabularDesktop";
import AdminOrderListMobile from "./TabularMobile";
import AdminOrderListGrid from "./Grid";
              ...
              <table className="is-fullwidth has-background-info-light table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="buttons is-right">
                        <Link to={`/admin/orders/search`} className="is-small">
                          View&nbsp;
                          <FontAwesomeIcon
                            className="mdi"
                            icon={faChevronRight}
