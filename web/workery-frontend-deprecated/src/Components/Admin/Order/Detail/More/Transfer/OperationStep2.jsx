// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Order/Detail/More/Transfer/OperationStep2.jsx
...
function AdminOrderMoreTransferOperationStep2() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSelectClick = (clientID, clientName) => {
    console.log("Selcted clientID:", clientID);

    // Save state to persistent storage (in client's web-browser).
    let newTransferOp = { ...transferOrderOperation };
    newTransferOp.pickedClientID = clientID;
    newTransferOp.pickedClientName = clientName;
...
export default AdminOrderMoreTransferOperationStep2;
