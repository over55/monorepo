// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Order/Search/ResultMobile.jsx
...
*/
function AdminOrderSearchResultMobile(props) {
  const {
    listData,
    setPageSize,
    pageSize,
...
export default AdminOrderSearchResultMobile;
