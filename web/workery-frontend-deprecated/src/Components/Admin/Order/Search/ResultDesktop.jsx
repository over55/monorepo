// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Order/Search/ResultDesktop.jsx
...
function AdminOrderSearchResultDesktop(props) {
  const {
    listData,
    setPageSize,
    pageSize,
...
export default AdminOrderSearchResultDesktop;
