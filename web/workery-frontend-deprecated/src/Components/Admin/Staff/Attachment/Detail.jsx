// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Staff/Attachment/Detail.jsx
...
function AdminStaffAttachmentDetail() {
  ////
  //// URL Parameters.
  ////
            ...
            {attachment && (
              <div className="columns">
                ...
                <div className="column has-text-right">
                  <Link
                    to={`/admin/staff/${aid}/attachment/${atid}/edit`}
...
export default AdminStaffAttachmentDetail;
