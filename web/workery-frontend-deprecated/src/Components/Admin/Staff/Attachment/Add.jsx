// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Staff/Attachment/Add.jsx
...
function AdminStaffAttachmentAdd() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    formData.append("ownership_type", 4); // 1=Customer, 2=Associate, 3=Order, 4=Staff
...
export default AdminStaffAttachmentAdd;
