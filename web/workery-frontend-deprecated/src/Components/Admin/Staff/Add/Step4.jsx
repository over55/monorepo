// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Staff/Add/Step4.jsx
...
function AdminStaffAddStep4() {
  ...
  const [postalCode, setPostalCode] = useState(addStaff.postalCode);
  const [addressLine1, setAddressLine1] = useState(addStaff.addressLine1);
  const [addressLine2, setAddressLine2] = useState(addStaff.addressLine2);
  const [city, setCity] = useState(addStaff.city);
  const [region, setRegion] = useState(addStaff.region);
  const [country, setCountry] = useState(addStaff.country);
  const [hasShippingAddress, setHasShippingAddress] = useState(
    addStaff.hasShippingAddress,
  );
  const [shippingName, setShippingName] = useState(addStaff.shippingName);
  const [shippingPhone, setShippingPhone] = useState(addStaff.shippingPhone);
  const [shippingCountry, setShippingCountry] = useState(
    addStaff.shippingCountry,
  );
  const [shippingRegion, setShippingRegion] = useState(addStaff.shippingRegion);
  const [shippingCity, setShippingCity] = useState(addStaff.shippingCity);
  const [shippingAddressLine1, setShippingAddressLine1] = useState(
    addStaff.shippingAddressLine1,
  );
  const [shippingAddressLine2, setShippingAddressLine2] = useState(
    addStaff.shippingAddressLine2,
  );
  const [shippingPostalCode, setShippingPostalCode] = useState(
    addStaff.shippingPostalCode,
  );
  ...
  const onSubmitClick = (e) => {
    ...
    modifiedAddStaff.postalCode = postalCode;
    modifiedAddStaff.addressLine1 = addressLine1;
    modifiedAddStaff.addressLine2 = addressLine2;
    modifiedAddStaff.city = city;
    modifiedAddStaff.region = region;
    modifiedAddStaff.country = country;
    modifiedAddStaff.hasShippingAddress = hasShippingAddress;
    modifiedAddStaff.shippingName = shippingName;
    modifiedAddStaff.shippingPhone = shippingPhone;
    modifiedAddStaff.shippingCountry = shippingCountry;
    modifiedAddStaff.shippingRegion = shippingRegion;
    modifiedAddStaff.shippingCity = shippingCity;
    modifiedAddStaff.shippingAddressLine1 = shippingAddressLine1;
    modifiedAddStaff.shippingAddressLine2 = shippingAddressLine2;
    modifiedAddStaff.shippingPostalCode = shippingPostalCode;
    setAddStaff(modifiedAddStaff);

    console.log("onSubmitClick: Ending with success.");

    // Redirect to the next page.
    setForceURL("/admin/staff/add/step-5");
  };
...
export default AdminStaffAddStep4;
