// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Staff/Add/Step1PartA.jsx
...
function AdminStaffAddStep1PartA() {
  ////
  //// Global state.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    setForceURL(
      "/admin/staff/add/step-1-results?fn=" +
        firstName +
        "&ln=" +
        lastName +
        "&e=" +
...
export default AdminStaffAddStep1PartA;
