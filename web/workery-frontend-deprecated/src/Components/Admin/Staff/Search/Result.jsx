// File Path: monorepo/web/workery-frontend-deprecated/src/Components/Admin/Staff/Search/Result.jsx
...
import { DEFAULT_STAFF_LIST_SORT_BY_VALUE } from "../../../../Constants/App";
import {
  addStaffState,
  ADD_ASSOCIATE_STATE_DEFAULT,
} from "../../../../AppState";
import { STAFF_STATUS_ACTIVE } from "../../../../Constants/App";

function AdminStaffSearchResult() {
  ////
  //// URL Parameters.
  ////
  ...
  const [status, setStatus] = useState(isActive ? STAFF_STATUS_ACTIVE : ""); // Filtering - Either by active or all records.
  ...
  const onAddStaffClick = (e) => {
    ...
    setAddStaff(ADD_ASSOCIATE_STATE_DEFAULT);
...
export default AdminStaffSearchResult;
